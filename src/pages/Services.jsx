    ...
    <div id="services" className=" w-[100%] pt-[20vh] flex flex-col gap-8 px-5 sm:px-0">
      <div className="flex items-center justify-between w-full   sm:flex-row flex-col gap-4">
        ...
        <div className="text-gray-500 w-full sm:w-[50%]">
          we have many interesting services , that will
      ...
      <div className=" grid grid-cols-1 md:grid-cols-3  sm:grid-cols-2 gap-8">
        {services.map((e,index) => {
          return (
            <div key={index} className="w-[100%] h-[30vh] flex flex-col items-center justify-center bg-gradient-to-r from-white via-gray-200 to-indigo-100 p-10 rounded text-black">
